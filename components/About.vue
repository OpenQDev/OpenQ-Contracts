...
.about
  ...
  .scroll
    ...
    &.show-about
      ...
      &:before
        @include inner-rounding
        bottom: -15px
        left: -11px
        clip: rect(0 14px 15px 0px)
      &:after
        @include inner-rounding
        bottom: -15px
        right: -11px
        clip: rect(0 28px 15px 14px)
    &.show-app
      ...
      &:before
        ...
        top: -15px
        left: -11px
        clip: rect(15px 14px 30px 0px)
      &:after
        @include inner-rounding
        top: -15px
        right: -11px
        clip: rect(15px 28px 30px 14px)
    &:hover
