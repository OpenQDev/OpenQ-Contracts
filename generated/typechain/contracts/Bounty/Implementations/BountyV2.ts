...
export interface BountyV2Interface extends utils.Interface {
  functions: {
    ...
    "setInvoiceable(bool)": FunctionFragment;
...
export interface BountyV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BountyV2Interface;
  ...
  functions: {
    ...
    invoiceable(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    invoiceable(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    invoiceable(overrides?: CallOverrides): Promise<PopulatedTransaction>;
