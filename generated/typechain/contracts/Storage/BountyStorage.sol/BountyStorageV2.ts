...
export interface BountyStorageV2Interface extends utils.Interface {
  functions: {
...
export interface BountyStorageV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BountyStorageV2Interface;
